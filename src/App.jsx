...
import TeamPairingRulesPage from '@/pages/TeamPairingRulesPage';
import AdminRoute from '@/components/organisms/AdminRoute/AdminRoute';
        ...
        <Route path="/*" element={
          <Layout>
            <Routes>
              ...
              <Route path="/history/:id" element={<TournamentHistoryDetailPage />} />
              <Route
                path="/admin/team-pairing"
                element={
                  <AdminRoute>
                    <TeamPairingRulesPage />
                  </AdminRoute>
                }
              />
